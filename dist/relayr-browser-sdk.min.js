...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.__RewireAPI__ = exports.__ResetDependency__ = exports.__set__ = exports.__Rewire__ = exports.__GetDependency__ = exports.__get__ = exports.device = undefined;
	...
	var device = exports.device = _get__('Device');
	...
	var Device = function () {
	    ...
	    _createClass(Device, [{
	        ...
	        value: function updateDevice(patch, raw) {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this.ajax.patch('/devices/' + _this.id, patch, { raw: raw }).then(function (response) {
	        ...
	        value: function sendCommand(command, raw) {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this3.ajax.patch('/devices/' + _this3.id, patch, { raw: raw }).then(function (response) {
	                    resolve(response);
	                }).catch(function (error) {
	                    reject(error);
	                });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mqtt = function () {
	    ...
	    _createClass(Mqtt, [{
	        ...
	        value: function _onConnectionLost() {
	    ...
	    _createClass(Model, [{
	        ...
	        value: function getAllModels() {
	            ...
	            return new Promise(function (resolve, reject) {
	                if (_get__('cache').public.toArray.length > 0) {
	                    ...
	                    _this.ajax.get('device-models', { queryObj: 'limit=100000', contentType: 'application/hal+json' }).then(function (response) {
	        ...
	        value: function getModel(id) {
	            ...
	            if (_get__('cache').public.toDictionary[id]) {
	                ...
	                return new Promise(function (resolve, reject) {
	                    _this2.ajax.get('device-models/' + id, { contentType: 'application/hal+json' }).then(function (model) {
